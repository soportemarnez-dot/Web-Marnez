...
_ALTERS = {
    ...
    "ajustes_diseno": [
        ...
        ("nosotros_page_hero", "VARCHAR(255)"),
        ("nosotros_page_eyebrow", "VARCHAR(80)"),
        ("nosotros_page_titulo", "VARCHAR(160)"),
        ("nosotros_historia", "TEXT"),
        ("nosotros_mision", "TEXT"),
        ("nosotros_vision", "TEXT"),
        ("nosotros_cifras_json", "TEXT"),
        ("nosotros_compromisos_titulo", "VARCHAR(160)"),
        ("nosotros_equipo_eyebrow", "VARCHAR(80)"),
        ("nosotros_equipo_titulo", "VARCHAR(160)"),
        ("nosotros_testimonios_titulo", "VARCHAR(160)"),
        ("nosotros_cta_titulo", "VARCHAR(160)"),
        ("nosotros_secciones_json", "TEXT"),
        ("equipo_fotos_json", "TEXT"),
        ("unete_page_hero", "VARCHAR(255)"),
        ("unete_page_subtitulo", "VARCHAR(220)"),
        ("unete_vacantes_titulo", "VARCHAR(160)"),
        ("unete_cv_titulo", "VARCHAR(160)"),
        ("unete_cv_texto", "TEXT"),
        ("unete_page_secciones_json", "TEXT"),
    ],
}
